...
if(e.userId===userCid){
        ...
        src= {e.file.contentType=='image/jpeg' || e.file.contentType=='image/png' ? require(`../Images/${e.filename}`):('../Images/moviefy.jpeg')}
      />
                                        </TableCell>
                                        ...
                                        <TableCell style={{ paddingBottom: 0, paddingTop: 0 }} colSpan={6}>
                                            <Collapse in={open && rowNo === index} timeout="auto" unmountOnExit>
                                                <Box sx={{ margin: 1, textAlign: 'center' }}>
                                                    ...
                                                    {/* <TextField variant='outlined' color='secondary' type={'text'} onChange={(e) => setType(e.target.value)} value={type} label='Type' sx={sty} required /> */}
